...
from SAM.utils.loading_utils import get_annotation_path, get_class_id_bbox_seg_from_yolo
from SAM.convert_yolo_pascal_voc import convert_yolo_to_pascal_voc

IMAGE_EXTS = (".jpg", ".jpeg", ".png")


class ImageProcessorBase:
    def __init__(self, image_folder, label_folder, label_out_folder, yaml_file, batch_size=None):
